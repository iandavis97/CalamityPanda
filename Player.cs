...
public class Player : MonoBehaviour
{
    ...
    //properties to handle sound effects
    public AudioSource gunShot;
    public AudioSource rollRev;
    public AudioSource rollLaunch;
